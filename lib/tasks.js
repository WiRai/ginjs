...
var tasks = {
  ...
  introduce_createProduct: function introduce_createProduct(productName) {
    ...
    var activate = nunjucks.render('activate.njk', {});
  ...
  introduce_createProductLine: function introduce_createProductLine(name) {
    ...
    if (fs.existsSync(newProductLineDir)) {
      (function () {
        var dirContentList = fs.readdirSync(newProductLineDir);
        var allowedContent = ['node_modules', 'package.json'];
        dirContentList.forEach(function (elem) {
